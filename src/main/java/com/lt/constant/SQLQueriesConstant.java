...
public class SQLQueriesConstant {
		...
		public static final String VIEW_PENDING_ADMISSION_QUERY = "select userId,name, password, role, gender, address, studentId from student, userNew where isApproved = 0 and studentId = userId";
		public static final String APPROVE_STUDENT_QUERY = "update Student set isApproved = 1 where studentId = ?";
		public static final String ADD_USER_QUERY = "insert into UserNew(userId, name, password, role, gender, address) values (?, ?, ?, ?, ?, ?)";
		...
		public static final String VIEW_PROFESSOR_QUERY = "select userId, name, gender, department, designation, address from Professor natural join UserNew where userId = professorId";
		...
		public static final String ADD_STUDENT="insert into student (studentId,department,semester,isApproved,isRegistered,isReportGenerated,isPaid) values (?,?,?,0,0,0,0)";
		...
		public static final String UPDATE_PASSWORD="update userNew set password=? where userId = ? ";
		public static final String VERIFY_CREDENTIALS="select password from UserNew where userId = ? ";
		public static final String GET_ROLE="select role from UserNew where userId = ? ";
		...
		public static final String GET_PROF_NAME = "select name from userNew where userId = ?";
